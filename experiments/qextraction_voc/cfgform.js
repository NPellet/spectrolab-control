...
html += '<label for="pulsetime">Pulse time</label>';
  html += '<div class="input-group">';
    html += '<input type="text" class="form-control" id="pulsetime" name="pulsetime" placeholder="Enter pulse time (s)" />';
...
html += '<label for="delaytime">Delay time</label>';
  html += '<div class="input-group">';
    html += '<input type="text" class="form-control" id="delaytime" name="delaytime" placeholder="Enter delay time (s)" />';
    html += '<span class="input-group-addon">s</span>';
  html += '</div>';
html += '</div>';
...
html += '<label for="timebase">Time base</label>';
  html += '<div class="input-group">';
    html += '<input type="text" class="form-control" id="timebase" name="timebase" placeholder="Enter time base" />';
...
html += '<label for="averaging">Number of averagings</label>';
  //html += '<div class="input-group">';
    html += '<input type="text" class="form-control" id="averaging" name="averaging" placeholder="Enter # of averages" />';
  //html += '</div>';
html += '</div>';
...
html += '<label for="averagingblank">Number of blank averagings</label>';
  //html += '<div class="input-group">';
    html += '<input type="text" class="form-control" id="averagingblank" name="averagingblank" placeholder="Enter # of blank averages" />';
  //html += '</div>';
html += '</div>';
